...
import { ArrowLeft, ExternalLink, Edit, Calendar, Globe, Figma } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      ...
      <details className="bg-gray-900/30 border border-white/10 rounded-xl overflow-hidden">
        <summary className="flex items-center gap-2 px-6 py-4 cursor-pointer text-sm font-medium text-gray-400 hover:text-white transition-colors">
